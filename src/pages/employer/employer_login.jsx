...
const EmployerLogin = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const savedCredentialsRaw = localStorage.getItem('employerCredentials');
        ...
        if (savedCredentialsRaw) {
            ...
            if (email === savedCredentials.email && password === savedCredentials.password) {
                login(savedUsername, 'employer');
                navigate('/employer/home');
            } else {
                alert('E-mail ou senha incorretos!');
            }
        } else {
            alert('Nenhum empregador cadastrado. Por favor, cadastre-se primeiro.');
        }
    };
